...
Keep this file during cleanup; it keeps the directory tracked.
...
- Task directories may live on temporary branches. Before merging into `main`, move durable conclusions to their authoritative homes and remove the temporary task directories.
