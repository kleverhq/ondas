...
- Backend internals belong in their own documents, including `vcd-native.md`, `fst-native.md` and `fsdb-lib.md`. Other integration constraints remain in `ghw.md` and `wlf.md`. Keep user-visible reader selection and limitations in Rustdoc.
